...
<head>
    ...
    <title>お知らせを修正する | ATSUMARI</title>
    <link rel="stylesheet"
...
<main class="board-page">
    <div class="board-inner">
        ...
        <form class="notice-write-form" method="post"
              action="${pageContext.request.contextPath}/notice/edit">
            ...
            <textarea id="content" name="content" rows="16"
                      required><c:out value="${notice.content}"/></textarea>

            <div class="notice-form-actions">
                <a href="${pageContext.request.contextPath}/notice/view?noticeNo=${notice.noticeNo}">
                    キャンセル
                </a>
