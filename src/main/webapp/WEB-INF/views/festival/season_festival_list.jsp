...
========================== -->
    ...
    ========================== -->
			...
			<div class="festival-title">
				...
				<a href="<%=request.getContextPath()%>/festival/season/card"
					class="other-region"> ← 他の季節の選択 </a> <span>FESTIVAL</span>

				<h1>${season}の祭り</h1>

				<p>${season}に開催される祭りをご紹介します。</p>
    ...
    ========================== -->
			...
			<div class="festival-top">
				...
				<div class="festival-count-area">
					...
					<div class="festival-season-buttons">

						<a
							href="${pageContext.request.contextPath}/festival/list?type=season&season=봄"
							class="season-button ${param.season == '봄' ? 'active' : ''}">
							春 </a> <a
							href="${pageContext.request.contextPath}/festival/list?type=season&season=여름"
							class="season-button ${param.season == '여름' ? 'active' : ''}">
							夏 </a> <a
							href="${pageContext.request.contextPath}/festival/list?type=season&season=가을"
							class="season-button ${param.season == '가을' ? 'active' : ''}">
							秋 </a> <a
							href="${pageContext.request.contextPath}/festival/list?type=season&season=겨울"
							class="season-button ${param.season == '겨울' ? 'active' : ''}">
							冬 </a>
    ...
    ========================== -->
			...
			<div class="festival-list">
				...
				<c:forEach var="festival" items="${festivalList}">
					...
					<a
						href="<%=request.getContextPath()%>/festival/view?festival_no=${festival.festival_no}&type=season&season=${param.season}"
    ...
    ========================== -->
			...
			<div class="festival-pagination">
				...
				<c:if test="${startPage > 1}">
					...
					<a
						href="${pageContext.request.contextPath}/festival/list?type=season&season=${param.season}&page=${currentPage - 1}&select=${select}&search=${search}"
						class="page-prev"> ← </a>
				...
				<c:forEach begin="${startPage}" end="${endPage}" var="pageNum">
					...
					<a
						href="${pageContext.request.contextPath}/festival/list?type=season&season=${param.season}&page=${pageNum}&select=${select}&search=${search}"
