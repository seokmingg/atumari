...
<div class="festival-inner">
    ...
    <div class="festival-top">
        ...
        <script src="<%=request.getContextPath()%>/assets/festival/js/festival_search.js">
        </script>
    ...
    <div class="festival-list">
        ...
        <c:forEach var="festival"
            ...
            <a href="<%=request.getContextPath()%>/festival/view?festival_no=${festival.festival_no}&type=season&season=${param.season}"
   			   class="festival-item">
...
<div class="festival-pagination">
    ...
    <c:if test="${currentPage > 1}">
        ...
        <a href="${pageContext.request.contextPath}/festival/list?type=season&season=${param.season}&page=${currentPage - 1}&select=${select}&search=${search}"
           class="page-prev">
    ...
    <c:forEach begin="1"
        ...
        <a href="${pageContext.request.contextPath}/festival/list?type=season&season=${param.season}&page=${pageNum}&select=${select}&search=${search}"
